...
//-----------------------------------------------【使用方法】-------------------------------------------------------
//      第一步：在Unity中拖拽此脚本到某物体之上，或在Inspector中[Add Component]->[浅墨's Toolkit]->[ShowObjectInfo]
...
//      PS：此脚本只用于编辑器中的运行和调试，实际发布后并不会有效。若需在发布后依然有效，请使用ShowObjectInfoInGamePlay脚本。
//      默认情况下文本信息仅在游戏运行时显示。
...
//添加组件菜单
[AddComponentMenu("浅墨's Toolkit/ShowObjectInfo")]
